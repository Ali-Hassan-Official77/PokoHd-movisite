...
export const metadata={title:"PokoHD — Discover Your Next Movie",description:"A smooth cinematic movie discovery experience powered by The Movie Database.",icons:{icon:"/logo.svg",shortcut:"/logo.svg",apple:"/logo.svg"}};
